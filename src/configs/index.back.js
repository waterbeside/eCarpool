...
let config = {
  ...
  urls          : {
    ...
    getOfentTrips : baseDomain + 'carpool/index/get_ofent_trips', //取得常用行程
    getMyroute    : baseDomain + 'carpool/index/myroute', //取得我的行程列表
    cancelRoute   : baseDomain + 'carpool/index/cancel_route', //取消行程
    finishRoute   : baseDomain + 'carpool/index/finish_route', //完结行程
    ...
    getWallView   : baseDomain + 'carpool/wall/get_view', // 取得空座位详细信息
    getWallViewPassengers: baseDomain + 'carpool/info/get_passengers', // 取得空座位乘客
